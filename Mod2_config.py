...
factorName = ['World Equities', 'US Treasuries', 'Bond Risk Premium',
...
# User Analysis Section.  Change the variables in this section to run
# user specific analysis

# isDemo is a boolean variable, set to True if the user wants to run
# custom analysis
isDemo = False
...
factorNameUser = ['World Equities', 'US Treasuries',
