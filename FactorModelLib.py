...
#import cvxpy as cp      # https://www.cvxpy.org/: "CVXPY is a Python-embedded modeling language for convex optimization problems. 
                        # It allows you to express your problem in a natural way that follows the math, rather than in the
...
We comment out this function because cp module not installed for my Anaconda (cvxpy)
def best_subset(x,y,l_0):
    # Mixed Integer Programming in feature selection
    # cp.matmul is matrix multiplication; x*b where b is coeffs, x is boolean feature vector, a is 
    # intercept    M = 1000
    n_factor = x.shape[1]
